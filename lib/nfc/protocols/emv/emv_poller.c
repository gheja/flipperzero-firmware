...
static const EmvPollerReadHandler emv_poller_read_handler[EmvPollerStateNum] = {
    ...
    [EmvPollerStateStartApplication] = emv_poller_handler_start_application,
...
const NfcPollerBase nfc_poller_emv = {
